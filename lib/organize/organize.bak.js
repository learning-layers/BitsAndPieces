var Organize = function(){
 ...
 Organize.prototype.svgDiv = null;
 ...
 // Left and right offset for the main svg canvas (Organize.prototype.svgDiv)
...
Organize.prototype.removeCircleAndEntity = function(event)
{
  var customevEnt, divSVG; 
    ...
    // this circle object should contain information about the circle and the label
                ...
                divSVG = Organize.prototype.svgDiv;    
...
Organize.prototype.unselectLabel = function()
{
    if (Organize.prototype.currentLabel!=null)
       ...
       */  
        ...
        var divSVG = Organize.prototype.svgDiv;    
...
Organize.prototype.drawSmallCircle = function(X,Y,bigCirc,bigRect,idSmallCic)
{
	...
	circ.on('mousedown', function(event) {
		...
		Organize.prototype.svgDiv.onmousemove= function(event) {	
...
{ 
    ...
    var el=Organize.prototype.svgDiv;  
...
Organize.prototype.loadOrganizeCanvas = function(divID)
{
       //divID= "bitsandpeaces"; // REMOVE XXXX!!!!!!!
        ...
        //  offset for the main svg canvas (Organize.prototype.svgDiv)
       if( typeof divID === 'string' )
           Organize.prototype.svgDiv = document.getElementById(divID);
       else 
           Organize.prototype.svgDiv = divID;
       ...
       $(Organize.prototype.SvgDiv).bind('keydown', function(event) {                      
