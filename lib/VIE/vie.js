...
// BnP special
    ...
    VIE.prototype.addAsIsAttribute = function(attr) {
        attr = VIE.Util.mapAttributeNS(attr, this.namespaces);
        this.asIsAttirbutes.push(attr);
    };

    VIE.prototype.getAsIsAttirbutes = function() {
        return this.asIsAttirbutes;
    };
// BnP special
};
...
VIE.prototype.Entity = Backbone.Model.extend({
  ...
  _previousOrGet: function(attr, previousOrGet){
    ...
    value = _.map(value, function(v) {
      ...
      // BnP special
      } else if (v !== undefined && this.vie.asIsAttirbutes.length > 0 && this.vie.asIsAttirbutes.indexOf(attr) !== -1 ) {
          // Special case, does not allow references, value returned as-is
          return v;
      // BnP special
