...
ORGANIZE.OrganizeView = Backbone.View.extend({
    ...
    AddCircle: function(event){
        ...
        this.views[id] = new SSS.EntityView({'model' : model});
    },
    ...
    addCircle: function(entity, collection, options ) {
        ...
        var view = new SSS.EntityView({'model':entity});
    ...
    addEntity: function(entity, collection, options) {
        ...
        */
        ...
        var view = new SSS.OrgaEntityView({model:entity});
        var data = {
            'x' : entity.get('x'),
            'y' : entity.get('y'),
