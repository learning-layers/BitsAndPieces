EP = window.EP || {};
EP.EpisodeManagerView = Backbone.View.extend({
    ...
    addEpisode: function(model, collection,options) {
        ...
        if( !collection || collection !== this.model.episodeCollection ) return;
        var view = new EP.EpisodeView({'model':model});
    ...
    createFromHere: function() {
        ...
        var epr = this;
        this.model.episodeCollection.create(new EP.EpisodeModel({
            'label' : 'New Episode'
        }), { 
